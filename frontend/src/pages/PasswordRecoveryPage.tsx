...
const PasswordRecoveryPage =()=>{
    ...
    return(
        <Layout style={{
            ...
            <div style={{fontSize:"24px"}}><b>Восстановление пароля</b></div>
          ...
          >
            ...
            <Button style={{background:"#16223d",}} type="primary" htmlType="submit" size='large'  icon={<ReloadOutlined />}>Восстановление пароля</Button>
